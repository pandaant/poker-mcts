...
SUITE(SimulationTests) {
  ...
  TEST_FIXTURE(TestStartup, TestFixedWin) {
    ...
    context->player[0].make_investment(bb(100), PhaseType::Preflop);
    context->player[1].make_investment(bb(9.5), PhaseType::Preflop);
    context->player[2].make_investment(bb(9), PhaseType::Preflop);
  ...
  TEST_FIXTURE(TestStartup, TestFixedWin2) {
    ...
    context->player[0].make_investment(bb(5), PhaseType::Preflop);
    context->player[1].make_investment(bb(4.5), PhaseType::Preflop);
    context->player[2].make_investment(bb(9), PhaseType::Preflop);
  ...
  TEST_FIXTURE(TestStartup, TestNotWinnablePot) {
    ...
    context->player[0].bankroll = 3;
    context->player[0].make_investment(bb(3), PhaseType::Preflop);
    context->player[1].make_investment(bb(4.5), PhaseType::Preflop);
    context->player[2].make_investment(bb(4), PhaseType::Preflop);
  ...
  TEST_FIXTURE(TestStartup, TestNotWinnablePot2) {
    ...
    context->player[0].bankroll = bb(100);
    context->player[0].make_investment(bb(100), PhaseType::Preflop);
    context->player[1].make_investment(bb(9.5), PhaseType::Preflop);
    context->player[2].make_investment(bb(9), PhaseType::Preflop);
  ...
  TEST_FIXTURE(TestStartup, TestSimulateContextAhAs) {
    ...
    con->pot = 10;
    // context->player[0].bankroll = 100;
    con->player[0].make_investment(bb(5), PhaseType::Preflop);
    con->player[1].make_investment(bb(4.5), PhaseType::Preflop);
  ...
  TEST_FIXTURE(TestStartup, TestSimulateContextNotWinnable) {
    ...
    con->pot = bb(110);
    con->player[0].bankroll = bb(10);
    con->player[1].bankroll = bb(99.5);
    con->player[0].make_investment(bb(10), PhaseType::Preflop);
    con->player[1].make_investment(bb(99.5), PhaseType::Preflop);
  ...
  TEST_FIXTURE(TestStartup, TestSimulateContextThatOneIsWon) {
    ...
    con->pot = 10;
    con->player[0].bankroll = 10;
    // con->player[1].bankroll = 99.5;
    con->player[0].make_investment(bb(5), PhaseType::Preflop);
    con->player[1].make_investment(bb(4.5), PhaseType::Preflop);
  ...
  void print_weights(vector<double> weights) {
    ...
    for (unsigned i = 0; i < weights.size(); ++i) {
      std::cout << i << ": "
                << std::string((int)(100 * (weights[i] / sum)), '#') << "\n";
    }
  }
